...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_H_

#include <stdint.h>

#include "sw/device/lib/base/bitfield.h"
#include "sw/device/silicon_creator/lib/epmp/epmp_defs.h"
 ...
 *
 * This library provides functions to create and manage a shadow copy of the
 * ePMP configuration in RAM. To update the hardware configuration please use
 * either assembly or the CSR library directly as needed*.
 */
...
/**
 * Shadow copy of the ePMP register state.
 */
 ...
 */
bool epmp_state_check(const epmp_state_t *state);

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_H_

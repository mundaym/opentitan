...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_DEFS_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_DEFS_H_
...
#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_EPMP_EPMP_DEFS_H_
